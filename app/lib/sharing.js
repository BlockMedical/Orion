...
/**
 * Open BlockMed file register page in a browser
 * @param {string[]} hashes
 */
export function registerOnBlockMed (hash, byteSize, category) {
  shell.openExternal(`https://ipfs.blockmed.me/file-register-bridge?hashId=${hash}&fileSize=${byteSize}&category=${category}`)
